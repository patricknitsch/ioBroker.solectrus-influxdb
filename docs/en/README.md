...
- The tab carries the generic heading **Sensors** with no further subheadings; the two grids below it are distinguished purely by their card color (see the color legend).
