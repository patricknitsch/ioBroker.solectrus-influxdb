		...
		return function SolectrusSensorsEditor(props) {
			...
			React.useEffect(() => {
				if (DEBUG && typeof console !== 'undefined' && typeof console.info === 'function') {
					const dataKeys =
						props && props.data && typeof props.data === 'object' && !Array.isArray(props.data)
					...
					console.info('[SolectrusSensorsEditor] mounted', {
						...
						onChangeLength:
							props && typeof props.onChange === 'function' ? props.onChange.length : undefined,
				...
				React.createElement(
					...
					expertMode
						? React.createElement(
								...
								React.createElement(
									'button',
									{ type: 'button', style: btnStyle, onClick: addSensor },
									t('Add'),
								),
								React.createElement(
									'button',
						...
						? React.createElement(
											...
											onClick: () => {
												if (!(DialogSelectID && socket && theme)) {
													if (
														...
														console.warn(
															'[SolectrusSensorsEditor] SelectID not available',
															{
																version: UI_VERSION,
																hasDialogSelectId: !!DialogSelectID,
																hasSocket: !!socket,
								...
								!expertMode && (editSensor.type || '') !== 'json'
									? React.createElement(
											...
											(function () {
												...
												var measurement = editSensor.measurement || '?';
												var field = editSensor.field || '?';
												...
												// Build inline-rich sensor info line: bold type, measurement, field
												...
												return [
													React.createElement(
														...
														{ key: 'si' },
														typeSplit[0],
														React.createElement('strong', { key: 'type' }, typeName),
														mfSplit[0],
														React.createElement('strong', { key: 'meas' }, measurement),
														':',
														React.createElement('strong', { key: 'field' }, field),
														mfSplit[1] || '',
													),
													'\n',
											...
											(function () {
												...
												return [
													React.createElement(
														...
														jsonSplit[0] || '',
														mappingPrefix,
														React.createElement('strong', { key: 'meas' }, m),
														':',
														React.createElement('strong', { key: 'field' }, f),
														mappingDesc,
														jsonSplit[1] || '',
													),
													'\n',
														...
														React.createElement(
															...
															React.createElement(
																...
																React.createElement('input', {
																	...
																	placeholder: 't',
																	onChange: e =>
																		setDraftField('jsonTsField', e.target.value),
																	onBlur: e =>
																		updateSelected('jsonTsField', e.target.value),
																}),
															),
															React.createElement(
																'div',
																...
																React.createElement('input', {
																	...
																	placeholder: 'y',
																	onChange: e =>
																		setDraftField('jsonValField', e.target.value),
																	onBlur: e =>
																		updateSelected('jsonValField', e.target.value),
																}),
															),
														),
														React.createElement(
														...
														React.createElement(
															'select',
															{
																...
																onChange: e => {
																	...
																	setTimeout(function () {
																		updateSelected('jsonInfluxType', val);
																	}, 0);
																},
															},
															React.createElement(
								...
								showSelectStateId && DialogSelectID && socket && theme
									? React.createElement(DialogSelectID, {
											...
											imagePrefix: '../..',
											dialogName:
												(props && (props.adapterName || props.adapter)) || 'solectrus-influxdb',
