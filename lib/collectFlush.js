...
const { getSensorStateId, isInfluxReady, hasEnabledSensors, getFlushIntervalMs, clampDelay } = require('./helpers');
...
async function collectPoints(adapter) {
	...
	for (const sensor of adapter.config.sensors) {
		...
		// Per-sensor maxValue takes precedence; default is DEFAULT_MAX_VALUE W.
