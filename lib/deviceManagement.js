...
const ADAPTER_ICON = 'data:image/svg+xml;base64,';
	...
	async _buildSensorDevice(sensor, state) {
		...
		if (lastTs) {
			customItems.timestamp = {
				...
				data:       tsDisplay,
				styleLabel: { fontWeight: 'bold' },
				styleValue: isAliveStale ? { color: staleColor } : {},
			};
		}
		...
		return {
			...
			hasDetails:      true,
			color:           '#ffffff',
			backgroundColor: isInternal ? '#fdd835' : '#388e3c',
			customInfo: {
				id:     { sensor: sensor.SensorName },
