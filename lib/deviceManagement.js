...
const TILE_COLOR_NORMAL = '#388e3c'; // default green for sensor tiles
const TILE_COLOR_MAX_EXCEEDED = '#e53935'; // red when max-value is exceeded
...
class SolectrusDeviceManagement extends DeviceManagement {
	...
	async loadDevices(context) {
		...
		for (const sensor of sensors) {
			...
			const color = isOverMax ? TILE_COLOR_MAX_EXCEEDED : TILE_COLOR_NORMAL;
